...
The goal of GeoPressureR is to help researcher to analyse pressure measurement made by geolocator. In particular, it provides a R wrapper around the . 
...
- Multiple package to analyse light: [GeoLight](https://github.com/slisovski/GeoLight/tree/Update_2.01) 
