...
saveRDS(pressure_prob[[1]], "inst/extdata/1_pressure/18LX_pressure_prob_1.rda")


# Compute the most likely path
p <- list(
  simple_path = geopressure_map2path(pressure_prob),
  interp_path = geopressure_map2path(pressure_prob, interp = 2),
...
static_prob_1_4 <- lapply(static_prob[c(1, 2, 3, 4)], function(raster) {
...
saveRDS(static_prob_1_4, "inst/extdata/3_static/18LX_static_prob_1_4.rda")
