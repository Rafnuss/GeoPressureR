...
path <- data.frame(
  ...
  start = as.POSIXct(c(1501113450, 1501888650, 1501987950, 1502075550, 1502151150), tz = "UTC"),
  end = as.POSIXct(c(1501876050, 1501961250, 1502046750, 1502133150, 1502323050), tz = "UTC"),
...
test_that("Check path2twilight() with path", {
  ...
  date <- seq(as.POSIXct("2017-08-1 12:00:00", tz = "UTC"),
    as.POSIXct("2017-08-10 12:00:00", tz = "UTC"),
    by = "day"
  )
