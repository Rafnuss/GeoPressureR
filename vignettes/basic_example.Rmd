...
In this example, we use data captured on a Great Reed Warbler (18LX). Below, we read the geolocator data and crop to equipment and retrieval date.
...
Based on the activity labeling, `pam_sta()` creates a table of stationary periods, illustrated below.
