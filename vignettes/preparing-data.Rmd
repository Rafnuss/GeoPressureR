...
To run the vizualization, you will need to save the data in a `.RData` in your home folder (`~`). I cannot find a good way to pass variable to a shiny app instance (let me know if you have a suggestion). 
...
geopressureviz = list(
  ...
  pressure_timeserie = pressure_timeserie
)
