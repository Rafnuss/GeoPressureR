...
This equation is reminiIt's quite easy to see that if $w_t=1$, the log linear pooling become identical to the case of independent $F = f_{ind}(\boldsymbol{\varepsilon})$. Case that we have alread explored earlier.
